      ...
      <form action="{{route('companyInfo.update',$company->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="tfDefault" name="name" placeholder="Enter Company Name" value="{{$company->name}}">
          </div><!-- /.form-group -->
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="tfDefault" name="pan_vat_no" placeholder="Enter pan/ vat Number" value="{{$company->pan_vat_no}}">
          </div><!-- /.form-group -->
          ...
          <div class="col-md-6 mb-3">
            ...
            <div class="custom-number">
              <input type="number" class="form-control" name="phone_no" placeholder="Enter Company Phone Number" value="{{$company->phone_no}}">
            </div>
          </div><!-- /.form-group -->
